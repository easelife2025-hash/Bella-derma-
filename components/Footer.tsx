...
export default function Footer() {
  return (
    <footer className="bg-stone-50 pb-32 md:pb-12 border-t border-stone-200">
      {/* Global CTA */}
      <div className="py-24 md:py-32 text-center px-6 border-b border-stone-200">
        <div className="max-w-3xl mx-auto">
          ...
          <Link href="/book" className="group bg-stone-900 text-stone-50 px-10 py-5 rounded-full text-xs uppercase tracking-[0.2em] font-medium hover:bg-stone-800 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 shadow-xl shadow-stone-900/10 inline-flex items-center gap-3">
      ...
      <div className="pt-16 max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
          <div className="flex flex-col gap-4">
            <h3 className="font-serif text-3xl text-stone-900 mb-2">Dr. Chitra&apos;s BellaDerma</h3>
            <p className="text-stone-500 font-light text-sm">
              Shop No. 14, Lenyadri Complex,<br/>
              Sector 19A, Nerul (E),<br/>
              Navi Mumbai
            </p>
            <p className="text-stone-900 font-medium text-sm mt-2">
              <a href="tel:+918591594849" className="hover:text-stone-500 transition-colors">+91 8591594849</a>
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-2 gap-8 md:gap-16">
            <div className="flex flex-col gap-4">
              <Link href="/treatments" className="text-sm font-light text-stone-500 hover:text-stone-900 transition-colors">Treatments</Link>
              <Link href="/#about" className="text-sm font-light text-stone-500 hover:text-stone-900 transition-colors">About</Link>
