...
export default function Footer() {
  return (
    <footer className="bg-stone-950 text-stone-100 pb-32 md:pb-12 border-t border-stone-800">
      {/* Global CTA */}
      <div className="py-24 md:py-32 text-center px-6 border-b border-stone-800/80 bg-gradient-to-b from-stone-950 to-stone-900/60">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl mb-8 tracking-tight text-stone-100">
            Ready to begin your <span className="italic text-amber-300 block mt-2">skin journey?</span>
          </h2>
          <p className="text-stone-400 font-light mb-12 max-w-lg mx-auto text-base md:text-lg">
            Schedule a comprehensive consultation to discuss your skin goals and develop a personalized treatment protocol.
          </p>
          <Link 
            href="/book" 
            className="group bg-gradient-to-r from-amber-400 via-amber-300 to-amber-500 text-stone-950 font-semibold px-10 py-5 rounded-full text-xs uppercase tracking-[0.2em] hover:brightness-110 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 shadow-xl shadow-amber-500/20 inline-flex items-center gap-3"
          >
